...
cargo run -- 'match to this line' -c 6 -C 6 -p syntect --term-width 80 --no-wrap              ./testdata/syntect/no_wrap_default.rs         > ./testdata/syntect/no_wrap_default.out
cargo run -- 'match to this line' -c 6 -C 6 -p syntect --term-width 80 --no-wrap --no-grid    ./testdata/syntect/no_wrap_no_grid.rs         > ./testdata/syntect/no_wrap_no_grid.out
cargo run -- 'match to this line' -c 6 -C 6 -p syntect --term-width 80 --no-wrap --background ./testdata/syntect/no_wrap_background.rs      > ./testdata/syntect/no_wrap_background.out
